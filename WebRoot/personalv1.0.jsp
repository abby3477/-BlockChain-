...
<div class="personal">
  ...
  <div class="span8">
    ...
    <div id="div3">
      ...
      <form action="/bonusPointsExchange/UserPointToplatformServlet"  method="post" onsubmit="return checkForm1();">
        <table>
          <tr>
            <td>选择商家：</td>
          ...
          <tr>
            <td>转移积分：</td>
            <td><input name="transfer_points"  type="number" min="1" value="1" id="transfer_points">
            </td>
          </tr>
          <tr>
            <td colspan="2" class="mid"><input name="submit" type="submit" class="submitBtn" id="submit" value="提交"></td>
    ...
    <div id="div4">
      ...
      <form action="/bonusPointsExchange/PlatformToUserServlet"  method="post" onsubmit="return checkForm2();">
        <table>
          <tr>
            <td>选择商家：</td>
          ...
          <tr>
            <td>转移积分：</td>
            <td><input name="transfer_points2" type="number" min="1" value="1" id="transfer_points2"></td>
          </tr>
          <tr>
            <td colspan="2" class="mid"><input name="submit" type="submit" class="submitBtn" id="submit" value="提交"></td>
              <td></td>
...
function checkForm1() {
	...
	if (transfer_points == ""||transfer_points == "0") {
		alert("转移积分不能为零！");
		return false;
	}
	
	var points=document.getElementById("points").value;
	if(Number(points)<Number(transfer_points)){
	alert("转移积分不能大于商家积分！");
		return false;
	}
 }
function checkForm2() {
	...
	var transfer_points2 = document.getElementById("transfer_points2").value;
	if (transfer_points2 == ""||transfer_points2 == "0") {
		alert("转移积分不能为零！");
		return false;
	}
	
	var platformPoints=document.getElementById("platformPoints").value;
	if(Number(platformPoints)<Number(transfer_points2)){
	alert("转移积分不能大于平台积分！");
		return false;
	}
 }
